...
global SYSDIC
    ...
    puts $file_writer "LDLIBS        = -ldl -lrt -lpthread -lboost_filesystem -lboost_iostreams -lboost_program_options -lboost_system -lboost_regex -lsnappy \$(LSST_SAL_PREFIX)/lib/libserdes++.a \$(LSST_SAL_PREFIX)/lib/libserdes.a -lcurl -ljansson -lrdkafka++ -lrdkafka -lavrocpp -lavro -lsasl2"
