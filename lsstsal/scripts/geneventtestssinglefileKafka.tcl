...
global SYSDIC
    ...
    puts $file_writer "PICFLAGS      = -fPIC"
     puts $file_writer "CPPFLAGS      = \$(PICFLAGS) \$(GENFLAGS) -g \$(SAL_CPPFLAGS) -D_REENTRANT -Wall -I\".\"  -I\"\$(AVRO_INCL)\" -I../../[set subsys]/cpp/src -I\"\$(LSST_SAL_PREFIX)/include\" -I\"\$(CONDA_PREFIX)/include\" -I\"\$(LSST_SAL_PREFIX)/include/avro\" -I\"\$(CONDA_PREFIX)/include/avro\" -I\"\$(LSST_SAL_PREFIX)/include/boost\" -I\"\$(CONDA_PREFIX)/include/boost\" -I.. -I\"\$(SAL_WORK_DIR)/include\" -fpermissive -Wno-write-strings $keyed"
