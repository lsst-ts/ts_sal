...
proc insertTelemetryMakeFile { subsys file_writer } {
    ...
    puts $file_writer "LDFLAGS       = -L\".\"  -L\"\$(SAL_DIR)/../lib\" -L\"\$(SAL_WORK_DIR)/lib\""
    ...
    puts $file_writer "LDLIBS        = -ldl -lrt -lpthread -lboost_filesystem -lboost_iostreams -lboost_program_options -lboost_system \$(SAL_DIR)/../lib/libserdes++.a \$(SAL_DIR)/../lib/libserdes.a -lcurl -ljansson -lrdkafka++ -lavrocpp -lavro"
