...
global AVRO_PREFIX
  ...
  puts $fout "                                 sal\[actorIdx\].avroName.c_str(),sal\[actorIdx\].avroName.size() , 0, headers);"
  ...
  puts $fout "     \} else \{"
  puts $fout "       if (debugLevel >1) \{"
  puts $fout "         std::cout << \"% Produced message (\" << outsize << \") bytes)\""
  puts $fout "                 << std::endl;"
  puts $fout "       \}"
  puts $fout "     \}"
...
global AVRO_PREFIX
  ...
  puts $fout "     \} else \{"
  puts $fout "       if (debugLevel >1) \{"
  puts $fout "         std::cout << \"% Produced ack message (\" << outsize << \" bytes)\""
  puts $fout "                 << std::endl;"
  puts $fout "       \}"
  puts $fout "     \}"
  puts $fout "     publisher->poll(0);"
